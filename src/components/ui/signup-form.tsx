        ...
        try {
            ...
            if (!response.ok) {
                ...
                toast.error('Signup failed!', {
                    description: 'Sign Up wasn&apos;t successful. Please try again.'
                });
            } else {
                setError(null);
            ...
            toast.error('Signup failed!', {
                description: 'An unexpected error occured. Please contact customer support.'
            });
        }
    };
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-balance text-muted-foreground">
                                    Sign up for a new Progex account
                                </p>
                            </div>
