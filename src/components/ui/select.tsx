...
const CustomSelect: React.FC<CustomSelectProps> = ({
  ...
  return (
    <SelectPrimitive.Root {...props}>
      <SelectPrimitive.Trigger className={cn("w-full bg-stone-800 dark:bg-black dark:border-white dark:border-2 border-black border-2 focus:ring-0", className)}>
        <SelectPrimitive.Value placeholder="Select status" />
      </SelectPrimitive.Trigger>
      <SelectPrimitive.Content className="border-white">
        {children}
